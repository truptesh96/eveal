...
<section class="services paddTb100" id="services">
	...
	<div class="wrapper">
		...
		<?php while ( have_rows('home_services') ) : the_row(); ?>
			<div class="service tabCol2 xxtabCol3 hoverCursor anim" onclick="window.location = '<?php the_sub_field("service_link"); ?>'" >
				...
				<div class="sslider">
	   				<div class="swiper-wrapper">
						<?php while ( have_rows('testimonials') ) : the_row(); ?>
							<div class="testimonial anim swiper-slide">

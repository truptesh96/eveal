				...
				<div class="dflex wrap vcenter">
					<div class="left xtabWid40 toRight anim ">
						...
						<?php if(get_field('footer_phone','option')) : ?>
							<div class="flink"><label>Call:</label> <a class="icn call" href="<?php the_field('footer_phone','option') ?>"><?php the_field('footer_phone','option') ?></a>
							</div>
						<?php endif; ?>

						<?php if(get_field('footer_email','option')) : ?>
							<div class="flink"><label>Email:</label> <a class="icn email" href="<?php the_field('footer_email','option') ?>"><?php the_field('footer_email','option') ?></a>
							</div>
						<?php endif; ?>

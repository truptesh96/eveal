 ...
 */
class Node implements \OTGS\Toolset\Twig_NodeInterface
{
    protected $nodes;
    ...
    public function __construct(array $nodes = [], array $attributes = [], $lineno = 0, $tag = null)
    {
        foreach ($nodes as $name => $node) {
            if (!$node instanceof \OTGS\Toolset\Twig_NodeInterface) {
    ...
    public function setSourceContext(\OTGS\Toolset\Twig\Source $source)
    {
...
\class_alias('OTGS\\Toolset\\Twig\\Node\\Node', 'OTGS\\Toolset\\Twig_Node');
// Ensure that the aliased name is loaded to keep BC for classes implementing the typehint with the old aliased name.
\class_exists('OTGS\\Toolset\\Twig\\Compiler');

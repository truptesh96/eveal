 ...
 */
class BlockNode extends \OTGS\Toolset\Twig\Node\Node
{
    public function __construct($name, \OTGS\Toolset\Twig_NodeInterface $body, $lineno, $tag = null)
    {
...
\class_alias('OTGS\\Toolset\\Twig\\Node\\BlockNode', 'OTGS\\Toolset\\Twig_Node_Block');

 ...
 */
namespace OTGS\Toolset\Twig\Util;
...
class DeprecationCollector
{
    ...
    public function __construct(\OTGS\Toolset\Twig\Environment $twig)
    {
        $this->twig = $twig;
    }
    /**
    ...
    public function collectDir($dir, $ext = '.twig')
    {
        ...
        return $this->collect(new \OTGS\Toolset\Twig\Util\TemplateDirIterator($iterator));
    }
    /**
    ...
    public function collect(\Traversable $iterator)
    {
        ...
        foreach ($iterator as $name => $contents) {
            try {
                $this->twig->parse($this->twig->tokenize(new \OTGS\Toolset\Twig\Source($contents, $name)));
...
\class_alias('OTGS\\Toolset\\Twig\\Util\\DeprecationCollector', 'OTGS\\Toolset\\Twig_Util_DeprecationCollector');

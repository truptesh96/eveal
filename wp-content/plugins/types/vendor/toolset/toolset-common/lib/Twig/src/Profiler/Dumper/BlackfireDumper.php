...
EOF;
    ...
    private function dumpChildren($parent, \OTGS\Toolset\Twig\Profiler\Profile $profile, &$data)
    {
    ...
    private function dumpProfile($edge, \OTGS\Toolset\Twig\Profiler\Profile $profile, &$data)
    {
        if (isset($data[$edge])) {
            ++$data[$edge]['ct'];
...
\class_alias('OTGS\\Toolset\\Twig\\Profiler\\Dumper\\BlackfireDumper', 'OTGS\\Toolset\\Twig_Profiler_Dumper_Blackfire');

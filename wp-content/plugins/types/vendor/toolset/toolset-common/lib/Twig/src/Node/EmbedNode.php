 ...
 */
class EmbedNode extends \OTGS\Toolset\Twig\Node\IncludeNode
{
    // we don't inject the module to avoid node visitors to traverse it twice (as it will be already visited in the main module)
    public function __construct($name, $index, \OTGS\Toolset\Twig\Node\Expression\AbstractExpression $variables = null, $only = \false, $ignoreMissing = \false, $lineno, $tag = null)
    {
        parent::__construct(new \OTGS\Toolset\Twig\Node\Expression\ConstantExpression('not_used', $lineno), $variables, $only, $ignoreMissing, $lineno, $tag);
...
\class_alias('OTGS\\Toolset\\Twig\\Node\\EmbedNode', 'OTGS\\Toolset\\Twig_Node_Embed');

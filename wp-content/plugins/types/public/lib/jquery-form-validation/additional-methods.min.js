...
// @since 3.3.11 slugs are valid, but the are sanitized in the backend. It is not a leftover, it still exists in case other plugin uses it
jQuery.validator.addMethod("rewriteslug",function(a,b){return this.optional(b)||/^.+$/i.test(a)},"No special characters please");

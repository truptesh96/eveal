...
/**
 * Class Types_Field_Type_Audio_Mapper_Legacy
 *
...
class Types_Field_Type_Audio_Mapper_Legacy extends Types_Field_Mapper_Abstract {
	 ...
	 * @param $id_post
	 *
	 * @return null|Types_Field_Type_Audio
	 * @throws Exception
	 */
	public function find_by_id( $id, $id_post ) {
		...
		if( $field['type'] !== 'audio' ) {
			throw new Exception( 'Types_Field_Type_Audio_Mapper_Legacy can not map type: ' . $field['type'] );
		}

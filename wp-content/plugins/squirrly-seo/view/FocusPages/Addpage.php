            ...
            <div class="flex-grow-1 px-1 sq_flex">
                ...
                <div class="card col-12 p-0">
                    <div class="card-body p-2 bg-title rounded-top">
                        ...
                        <h3 class="card-title"><?php echo esc_html__("Add a page in Focus Pages", _SQ_PLUGIN_NAME_); ?>
                                                            ...
                                                            if (isset($post->ID) && $post->ID > 0) {
                                                                ...
                                                                <form method="post" class="p-0 m-0">
                                                                    ...
                                                                    <button type="submit" class="btn btn-sm text-white btn-success" style="width: 150px;">
                                                                        <?php echo esc_html__("Set Focus Page", _SQ_PLUGIN_NAME_) ?>
                                                                    </button>
                                                                </form>
                                                            <?php } else { ?>
                                                                <span class="text-danger font-weight-bold text-center" title="<?php echo esc_html__("Only pages with IDs can be added as Focus Page", _SQ_PLUGIN_NAME_) ?>"><?php echo esc_html__("Can't be added", _SQ_PLUGIN_NAME_) ?> <a href="https://howto.squirrly.co/kb/focus-pages-page-audits/#add_new_focus_page" target="_blank" ><i class="fa fa-question-circle"></i></a></span>
                                                            <?php } ?>
                                                        <?php } else { ?>
                                                            <a href="<?php echo SQ_Classes_Helpers_Tools::getAdminUrl('sq_focuspages', 'pagelist', array('sid=' . $focuspage->id)) ?>" class="btn btn-sm text-white bg-success bg-green text-center" style="width: 150px;"><?php echo esc_html__("See Tasks", _SQ_PLUGIN_NAME_) ?></a>
                                                        <?php } ?>
                                                    </td>
